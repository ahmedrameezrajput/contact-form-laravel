...
<body>
    <div class="h-screen bg-[#FFFBEB]">
        ...
        <div class="text-center pb-20">
            <a href="/contact">
                <button class="mt-5 rounded-md bg-[#263159] px-8 py-2 text-[#FFFBEB] hover:bg-[#495579] inline-flex gap-x-4">
                    ...
                    <tr class="border-b border-neutral-500">
                        ...
                        <td class="whitespace-nowrap px-6 py-4">
                            <div class="inline-flex gap-4">
                                <button type="button" onclick="document.getElementById('update-form').submit();" class="hover:scale-110">
